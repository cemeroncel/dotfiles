...
;; Create a copy this file and rename it to `init.el'!
...
;; Load the keybindings module first so that our keymaps are available.
(require 'ce-keybindings)
